...
class RegisterController extends Controller
{
    ...
    { 
        ...
        $success['date_of_birth'] = $user->dob;

        if($success){
            return response()->json([
                "SuccessCode" => 200 ,
                "Message"=>"Registration successfull",
                "Data"=>$success], $this->successStatus); 
        }
        else{
            return response()->json([
                "failure" => 400 ,
                "Message"=>"Please Enter correct email"], $this->errorStatus); 
        }
    ...
    {   
        if(Auth::attempt(['email' => request('email'), 'password' => request('password')])){  
            ...
            return response()
            ->json(["SuccessCode" => 400 ,"Message"=>"Your Credential Does not match"]); 
        }  
    } 
    ...
    {
        // echo "Logout";
        // $result = $request->session()->forget('id');  
        
        // if($result){
        //     return response()->json([
        //         'SuccessCode' => 200, "Message"=> "You Logged Out",
        //     ]);
        // }
